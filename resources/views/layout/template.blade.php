    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pariwisata <sup>SumbaTimur</sup></div>
            </a>
...
          </li>
            ...
            <a class="nav-link" href="{{ route('hotel') }}">
              <i class="ti-user menu-icon"></i>
              <span class="menu-title">Kriteria Hotel</span>
            </a>
          </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
...
          </li>
            ...
            <a class="nav-link" href="{{ route('hotel') }}">
              <i class="ti-user menu-icon"></i>
              <span class="menu-title">Atraksi</span>
            </a>
          </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Pariwisata SumbaTimur</strong> is packed with premium features, components, and more!</p>
